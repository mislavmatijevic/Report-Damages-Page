...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60c64c355cbeb3_18698041',
...
function content_60c64c355cbeb3_18698041 (Smarty_Internal_Template $_smarty_tpl) {
...
">
        ...
        <input id="username" name="username" <?php if ((isset($_smarty_tpl->tpl_vars['loginUser']->value["username"]))) {?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['loginUser']->value["username"]);?>
" <?php }?> />
        <span id="error-username" class="error"></span>
        <label for="password" class="section-login_form-password">Lozinka: </label>
        <input id="password" name="password" type="password" <?php if ((isset($_smarty_tpl->tpl_vars['loginUser']->value["password"]))) {?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['loginUser']->value["password"]);?>
"
            <?php }?> />

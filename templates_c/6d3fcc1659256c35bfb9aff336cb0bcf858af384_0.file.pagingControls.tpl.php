...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60c641293a3db6_79508753',
...
function content_60c641293a3db6_79508753 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="paging">
...
">
        ...
        <button id="back" name="page" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currentPage']->value-1);?>
" type="submit">⏮️</button>
        <progress name="page" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currentPage']->value);?>
...
/<?php echo $_smarty_tpl->tpl_vars['maxPage']->value;?>
        ...
        <button id="next" name="page" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currentPage']->value+1);?>
" type="submit">⏭️</button>
        <button id="last" name="page" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['maxPage']->value);?>
